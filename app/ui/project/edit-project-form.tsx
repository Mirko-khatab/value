...
export default function EditProjectForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await updateProject(projectId, nativeFormData);
  ...
  return (
    <form onSubmit={handleSubmit} className="text-gray-900 dark:text-gray-200">
      <div className="rounded-md bg-gray-50 dark:bg-gray-800 p-4 md:p-6 transition-colors duration-200">
        ...
        {/* Form Fields */}
        <div className="grid md:grid-cols-2 grid-cols-1 text-gray-900 dark:text-gray-200 gap-4 mb-4">
          {/* Title English */}
          <div className="mb-4">
            <label
              htmlFor="title_en"
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 text-gray-900 dark:text-white dark:bg-gray-700"
            />
          </div>
          ...
          <div className="mb-4">
            <label
              htmlFor="title_ar"
              className="mb-2 block text-sm text-gray-900 dark:text-white  font-medium"
            >
          ...
          <div className="mb-4">
            ...
            <select
              ...
              name="project_status"
              required
              value={formData.project_status || "0"}
              onChange={(e) =>
                handleInputChange("project_status", e.target.value)
              }
              className="w-full px-4 py-2 border rounded-md focus:ring-2 dark:focus:ring-white focus:ring-blue-500 text-gray-900 dark:text-gray-200 dark:bg-gray-700"
            >
              <option
