          ...
          <div className="mb-6 md:mb-0 flex flex-col gap-4 md:w-1/2  px-2">
            ...
            <div>
              <h3 className="text-sm text-black dark:text-white sm:text-left dark:text-gray-400 transition-colors duration-200">
                ...
                laboriosam quod architecto corrupti enim asperiores temporibus
                ut harum error officiis! Distinctio laudantium ad dolores
                tenetur iusto quidem repellat delectus rem?
              </h3>
            </div>
          </div>
